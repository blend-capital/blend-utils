...
export async function deployPoolFactory(stellarRpc: Server, source: Keypair, config: Config) {
...
export async function installPoolFactory(stellarRpc: Server, source: Keypair, config: Config) {
